...
public class Activity4 extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String date = getIntent().getStringExtra("DATE2");
        textview11.setText("Term End Date: " + date);
        textview10 = (TextView) findViewById(R.id.textView10);
        String party = getIntent().getStringExtra("PARTY2");
        textview10.setText(party);
        textview9 = (TextView) findViewById(R.id.textView9);
        String name = getIntent().getStringExtra("NAME2");
        textview9.setText(name);
        imageview2 = (ImageView) findViewById(R.id.imageView2);
        String image = getIntent().getStringExtra("TWITTER2");
        Picasso.with(Activity4.this).load("https://twitter.com/" + image + "/profile_image?size=original").into(imageview2);
    }
}
